...
export function calculateOfferScore({
  ...
  // Se não temos nem desconto confirmado nem comissão conhecida,
  // não existe base suficiente para chamar a oferta de "low".
  if (
    !hasDiscountData &&
    !hasCommissionData
  ) {
    return {
      ...
      scoreBreakdown: {
        discountScore: null,
        commissionRateScore: null,
        estimatedEarningScore: null
      },

      scoreSignals: {
        hasDiscountData,
        hasCommissionData,
        hasEstimatedEarningData
      },
