...
export const TT_DISCOVERY_GROUPS = {
  ...
  perfumes: [
    ...
    { key: "body_00", categoryQuery: "body splash fragrancia", scanOffset: 0, label: "Body Splash", expectedTtCategoryId: "moda_beleza" },
    { key: "kit_00", categoryQuery: "kit perfume feminino masculino", scanOffset: 0, label: "Kits de Perfume", expectedTtCategoryId: "moda_beleza" },
